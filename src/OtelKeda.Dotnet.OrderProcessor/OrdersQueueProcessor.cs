...
namespace OtelKeda.Dotnet.OrderProcessor
{
    public class OrdersQueueProcessor : QueueWorker<Order>
    {
        ...
        protected override async Task<string> ProcessMessage(Order order, string messageId, IReadOnlyDictionary<string, object> userProperties, CancellationToken cancellationToken)
        {
